...
public class AttributFinal {
   ...
   //valifdation
    public static final String  CHECK_DOCTOR_AVAILABILITY_BY_LOGIN = "SELECT * FROM doctors WHERE login=?";
    ...
    public static final String  CHECK_PATIENT_AVAILABILITY_BY_PHONE = "SELECT * FROM patients WHERE phone=?";
}
