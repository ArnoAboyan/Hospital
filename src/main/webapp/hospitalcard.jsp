...
<c:set var="currentAddressPage" value="controller?command=hospitalcardbypatientid&patientid=${patient.patientId}&doctorid=${doctor.doctorId}" scope="session"></c:set>
...
<section class="adminpage-hospitalcard flex">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-4 fs-4"><fmt:message key="admin_jsp.Doctor"/>:<br>${doctor.doctorName} ${doctor.doctorSurname} | ${doctor.category}</div>
      <div class="col-4 fs-4"></div>
      <div class="col-4 fs-4"><fmt:message key="admin_jsp.Patient"/>:<br>${patient.patientName} ${patient.patientSurname}<br>${patient.patientDateOfBirth}<br>${patient.patientPhone}</div>
...
<div class="modal fade" id="changecardModal" tabindex="-1" aria-labelledby="changecardModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel"><fmt:message key="admin_jsp.hospitalcardChangeCard"/></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
          ...
          <div class="accordion-item">
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                <textarea class="form-control" name="procedures" rows="5" id="procedures">${hospitalcard.procedures}</textarea>
              </div>
            </div>
          </div>
          <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                <textarea class="form-control" name="medications" rows="5" id="medications">${hospitalcard.medications}</textarea>
              </div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingThree">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                <fmt:message key="admin_jsp.hospitalcardOPERATION"/>
              </button>
            </h2>
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                <textarea class="form-control" name="operations" rows="5" id="operations">${hospitalcard.operations}</textarea>
              </div>
            </div>
          </div>
          <div class="accordion-item">
            <h2 class="accordion-header" id="headingFore">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFore" aria-expanded="false" aria-controls="collapseFore">
                <fmt:message key="admin_jsp.hospitalcardDIAGNOSIS"/>
              </button>
            </h2>
            <div id="collapseFore" class="accordion-collapse collapse" aria-labelledby="headingFore" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                <textarea class="form-control" name="diagnosis" rows="5" id="diagnosis">${hospitalcard.diagnosis}</textarea>
              </div>
            </div>
          </div>
        </div>
          <button type="submit" class="btn btn-secondary btn-lg"><fmt:message key="admin_jsp.hospitalcardSave"/></button>
          </form>
      </div>
    </div>
  </div>
