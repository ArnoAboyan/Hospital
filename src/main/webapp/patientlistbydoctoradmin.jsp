...
<section class="adminpage-patientbydoctorid flex">
  <h3><fmt:message key="admin_jsp.Patientsfor"/>: ${doctor.doctorName} ${doctor.doctorSurname} <span class="badge bg-info" style="background-color: #e3f2fd;">${numberOfPatients}</span></h3>
