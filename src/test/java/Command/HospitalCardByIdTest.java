...
class HospitalCardByIdTest {
    ...
    void executeTest() throws SQLException, DAOException, CommandException {
        ...
        when(req.getParameter("hospitalCardId")).thenReturn("5");
        ...
        when(con.prepareStatement(AttributFinal.GET_HOSPITALCARD_BY_ID)).thenReturn(psOne);
        ...
        HospitalCardById hospitalCardById = new HospitalCardById();


        String actual = hospitalCardById.execute(req, resp);
        String expected = "hospitalcardfornurse.jsp";
